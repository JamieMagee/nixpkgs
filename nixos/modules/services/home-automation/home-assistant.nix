...
in
{
            ...
            lovelace = {
              ...
              dashboards = mkOption {
                ...
                description = ''
                  ...
                  {option}`lovelaceConfigFile` is set, this defaults to a YAML-mode dashboard
                  named `lovelace`.
  ...
  config = mkIf cfg.enable {
    warnings = optionals (cfg.config != null && cfg.config ? lovelace && cfg.config.lovelace ? mode) [
      ''
